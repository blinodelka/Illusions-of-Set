...
setwd("/home/marina/Documents/Projects/Illusions_of_set/Set 1/data")
...
model1 <- glmer(answer.keys ~ size + number_of_fixational_trials + (1|participant) + (size|participant), data = data_best, family = binomial) # doesn't converge with individual effects of num_of_trials
summary(model)
model10 <- glmer(size ~ 1 + (1|participant), data = data_best)
summary(model10)
